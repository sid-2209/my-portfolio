    ...
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <select
          ...
          className="border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 bg-white focus:border-gray-800 focus:ring-2 focus:ring-gray-200"
        >
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-2xl font-bold text-gray-900">{featuredContent}</p>
            </div>
          </div>
        </div>
      </div>
