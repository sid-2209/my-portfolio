...
import { getContentTypeLabel, getContentTypeColor } from '../lib/utils/contentTypeLabels';
        ...
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center space-x-3 mb-3">
              <span className={`text-xs font-medium uppercase tracking-wide px-2 py-1 rounded-full ${getContentTypeColor(content.contentType)}`}>
                {getContentTypeLabel(content.contentType)}
              </span>
              <div className="w-px h-3 bg-gray-300"></div>
              <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                {formatDate(content.publishedDate, 'short')}
              </span>
            </div>
